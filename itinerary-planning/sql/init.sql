...
CREATE TABLE `destinations` (
    `id` BIGINT NOT NULL COMMENT '目的地ID',
...
-- 插入示例目的地数据
INSERT INTO `destinations` (`id`, `name`, `description`, `city`, `province`, `category`, `rating`, `open_time`, `ticket_price`) VALUES
(1000000000000000001, '西湖', '杭州最著名的自然景观，世界文化遗产', '杭州', '浙江', '景点', 4.8, '全天开放', 0.00),
(1000000000000000002, '灵隐寺', '千年古刹，杭州著名佛教寺院', '杭州', '浙江', '景点', 4.6, '07:00-18:00', 75.00),
(1000000000000000003, '外滩', '上海的标志性景观，万国建筑博览群', '上海', '上海', '景点', 4.7, '全天开放', 0.00),
(1000000000000000004, '南京路步行街', '中华商业第一街，购物天堂', '上海', '上海', '购物', 4.3, '全天开放', 0.00),
(1000000000000000005, '故宫博物院', '世界上最大的古代宫殿建筑群', '北京', '北京', '景点', 4.9, '08:30-17:00', 60.00),
(1000000000000000006, '南锣鼓巷', '北京最古老的街区之一，小吃和文创聚集地', '北京', '北京', '美食', 4.2, '全天开放', 0.00),
(1000000000000000007, '宽窄巷子', '成都历史文化街区，体验巴蜀文化', '成都', '四川', '美食', 4.4, '全天开放', 0.00),
(1000000000000000008, '大熊猫繁育研究基地', '近距离观赏国宝大熊猫', '成都', '四川', '景点', 4.8, '07:30-18:00', 55.00);
